...
/**
 * Test config class for FacebookOffline usage
 * Spring Social Configuration.
 * 
 * @author Yves Nicolas
 */
    @Configuration
    public class TestConfigFBOnline {
    
   
    
    	@Bean
    	public FacebookOffline facebookOffline() {
    	    return new FacebookOffline(new User("yves@dynamease"));
    	}
    }
